...
import math
import modules
#from modules import detect_people
from scipy.spatial import distance as dist
#from modules import camera_no


labelsPath = "C:/Users/loges/OneDrive/Documents/yolo-coco/coco.names.txt"
LABELS = open(labelsPath).read().strip().split("\n")
np.random.seed(42)
COLORS = np.random.randint(0,255,size=(len(LABELS), 3),dtype="uint8")

weightsPath = "yolo-coco/yolov3.weights"
configPath = "C:/Users/loges/OneDrive/Documents/yolo-coco/yolov3.cfg"
